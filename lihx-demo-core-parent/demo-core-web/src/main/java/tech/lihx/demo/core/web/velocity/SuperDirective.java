...
public class SuperDirective extends org.apache.velocity.runtime.directive.Directive {
	...
	public boolean render( InternalContextAdapter context, Writer writer, Node node ) throws IOException,
		...
		if ( current == null ) { throw new ParseErrorException("#super direction must be child of override"); }
		OverrideNodeWrapper parent = current.parentNode;
		if ( parent == null ) { throw new ParseErrorException("not found parent block for #super "); }
